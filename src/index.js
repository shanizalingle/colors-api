...
function printCharacter(character) {
  ...
  document.querySelector("#showRick").innerText = `Your character is ${character[0].results[randomRick].name}`
  //document.querySelector('#charimg').src = `${character["results"][0]['image']}`
}
